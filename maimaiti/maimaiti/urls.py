...
urlpatterns = patterns('',
    ...
    url(r'^redirect_login/','user.views.redirect_login'),
    ...
    url(r'^follow/follow_user/(?P<following_id>\d+)','follow.views.follow_user'),
    url(r'^follow/unfollow_user/(?P<following_id>\d+)','follow.views.unfollow_user'),
    ...
    url(r'^collection/collect/(?P<post_id>\d+)','collection.views.collect'),
    url(r'^collection/cancel_collect/(?P<post_id>\d+)','collection.views.cancel_collect'),
)
